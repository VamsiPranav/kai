...
def main():
    ...
    top_common_products = top_common_products[['Product Brand_x', 'Product Name_x', 'Quantity Remaining_x', 'MRP_x', 'Weighted Cost Price_x', 'Minimum Price_x', 'Weighted Shelf Score_x', 'Viability Score_x', '1-15 Days_x', 'Together Bought With_x', 'Similar Products_x', 'Stock wrt Demand_x', 'Past 15 Day Sales_x']]
    ...
    bottom_common_products = bottom_common_products[
        ['Product Brand_x', 'Product Name_x', 'Quantity Remaining_x', 'MRP_x', 'Weighted Cost Price_x',
         ...
         'Similar Products_x', 'Stock wrt Demand_x', 'Past 15 Day Sales_x']]
