...
def setup_agent_router(local_llm):
    ...
    prompt = PromptTemplate(
        ...
        Whenever the question has covers 'all' products or more than one areas (like reorder dates and also which products to buy or stock out alerts and also discounts) or ask more than one question or asks to give "overview", then route them to "overview-agent". \n
