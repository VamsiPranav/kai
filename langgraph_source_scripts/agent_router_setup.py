...
def setup_agent_router(local_llm):
    ...
    prompt = PromptTemplate(
        ...
        Whenever the question is about a particular product, or a any general question that is not directly related to inventory management or timeline management, then route to "general-query-agent". \n
